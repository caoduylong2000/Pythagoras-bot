...
export class DefaultSocket {
    ...
    session;
    constructor(host, port, useSSL = false, verbose = false, adapter = new WebSocketAdapterText(), sendTimeoutMs = DefaultSocket.DefaultSendTimeoutMs) {
        this.host = host;
        this.port = port;
        this.useSSL = useSSL;
        ...
        this.adapter.onMessage = (message) => {
            ...
            if (!message.cid) {
                for (const event in InternalEventsSocket) {
                    const fieldName = InternalEventsSocket[event];
            ...
            if (!this.adapter.isOpen()) {
                ...
                if (untypedMessage.channel_message_send) {
                    ...
                    untypedMessage.ephemeral_message_send.message.content =
                        JSON.stringify(untypedMessage.ephemeral_message_send.message?.content);
                }
