...
class MezonApi {
    ...
    mezonHealthcheck(bearerToken, options = {}) {
        ...
        const fetchOptions = (0, utils_1.buildFetchOptions)("GET", options, bodyJson);
        if (bearerToken) {
    ...
    mezonDeleteMessage(bearerToken, id, options = {}) {
        ...
        let bodyJson = "";
        const fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
        const fetchOptions = (0, utils_1.buildFetchOptions)("DELETE", options, bodyJson);
        if (bearerToken) {
            fetchOptions.headers["Authorization"] = "Bearer " + bearerToken;
        }
        return Promise.race([
    ...
    mezonUpdateMessage(bearerToken, id, body, options = {}) {
        ...
        bodyJson = JSON.stringify(body || {});
        const fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
        const fetchOptions = (0, utils_1.buildFetchOptions)("PUT", options, bodyJson);
        if (bearerToken) {
            fetchOptions.headers["Authorization"] = "Bearer " + bearerToken;
        }
        return Promise.race([
