...
exports.refGenerate = exports.fieldGenerate = exports.replyMessageGenerate = void 0;
function replyMessageGenerate(replayContent, message) {
    const replayMessage = {};
    const defaultValue = {
        mentions: [],
        attachments: [],
...
exports.replyMessageGenerate = replyMessageGenerate;
function fieldGenerate(field, replayContent, message, defaultValue) {
...
exports.fieldGenerate = fieldGenerate;
function refGenerate(msg) {
    return [
        {
            message_id: "",
...
exports.refGenerate = refGenerate;
