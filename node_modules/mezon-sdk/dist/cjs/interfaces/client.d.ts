...
export declare enum EMessageComponentType {
    BUTTON = 1,
    SELECT = 2,
    INPUT = 3,
    DATEPICKER = 4,
...
export declare enum EMessageSelectType {
    TEXT = 1,
    USER = 2,
    ROLE = 3,
    CHANNEL = 4
...
export interface Client {
    ...
    sendDMChannelMessage: (userId: string, msg: string, messOptions: {
        [x: string]: any;
    }, attachments: Array<ApiMessageAttachment>, refs: Array<ApiMessageRef>) => Promise<ChannelMessageAck>;
}
